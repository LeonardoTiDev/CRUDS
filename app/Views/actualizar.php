...
<body>
    ...
    <div class="container">
	   ...
	   <input type="date" name="fechanc" id="fechanc" class="form-control"    value="<?php echo $fechaNac ?>" >

	   <label for="direccion">Direccion</label>
	   <input type="text" name="direccion" id="direccion" class="form-control"     value="<?php echo $direccion ?>" >

	   <label for="mail">Correo Electronico</label>
	   <input type="text" name="mail" id="mail" class="form-control"    value="<?php echo $correo ?>" >

	   <label for="tel">Telefono</label>
	   <input type="text" name="tel" id="tel" class="form-control"     value="<?php echo $telefono ?>">
                    <br>
